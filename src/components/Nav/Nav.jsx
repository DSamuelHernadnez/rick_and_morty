...
//    // Función para generar 1 ID aleatorio
//    const handleRandom = () => {
//       const randomId = Math.floor(Math.random() * 826) + 1;
//       onSearch(randomId);
//    };

//    // Nueva función para generar 10 IDs aleatorios
//    const handleTenRandom = () => {
//       if (!onSearch) return; // Guard clause profesional
...
//             {/* NUEVO BOTÓN: 10 RANDOM */}
//             <button className={styles.tenRandomBtn} onClick={handleTenRandom}>
//                ADD 10 RANDOM
//             </button>
//          </div>
